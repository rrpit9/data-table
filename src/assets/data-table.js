(function($) {
    ...
    $.dataTable = function(element, options) {
        ...
        var sorting = function() {
            ...
            $element.find('.dt--sorting > i.mdi').addClass('mdi-sort').removeClass('mdi-sort-ascending mdi-sort-descending');
            if(sortType == 'asc') {
                $(this).addClass('dt--sorting-asc');
                $(this).find('.mdi').addClass('mdi-sort-ascending').removeClass('mdi-sort');
            } else {
                $(this).addClass('dt--sorting-desc');
                $(this).find('.mdi').addClass('mdi-sort-descending').removeClass('mdi-sort');
            }
